...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Nueva cuenta de usuario</li>
@endsection
...
<button class="btn btn-sm btn-primary ml-auto waves-effect waves-themed" type="button" onclick="button_submit($('#myform'))"><i class="fal fa-check"></i> Guardar</button>
@endsection
