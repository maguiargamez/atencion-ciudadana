                    ...
                    <header class="page-header" role="banner">
                        ...
                        <div class="page-logo">
                            <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                                {{-- <img src="{{ asset('assets/img/logo.png') }}" alt="Logo" aria-roledescription="logo"> --}}
                                <span class="page-logo-text mr-1">Atención ciudadana</span>
                        ...
                        <div class="search">
                            <form class="app-forms hidden-xs-down" role="search" action="page_search.html" autocomplete="off">
                                <input type="text" id="search-field" placeholder="Busqueda general" class="form-control" tabindex="1">
                        ...
                        <div class="ml-auto d-flex">
                            ...
                            <!--<div>
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-xl">
                                    <div class="dropdown-header bg-trans-gradient d-flex justify-content-center align-items-center rounded-top mb-2">
                                        <h4 class="m-0 text-center color-white">
                                            Notificaciones
                                            <small class="mb-0 opacity-80">11 nuevas notificaciones</small>
                                        </h4>
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            ...
                                            <div class="info-card-text">
                                                <div class="fs-lg text-truncate text-truncate-lg">{{ Auth::User()->nombre }}</div>
                                    ...
                                    <a href="{{ route('cuentas-usuario.cambiar-contrasenia',  Auth::User()->id ) }}" class="dropdown-item" >
                                        <span data-i18n="drpdwn.reset_layout">Cambiar contraseña</span>
                                    </a>
                                    ...
                                    <a class="dropdown-item fw-500 pt-3 pb-3" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                        ...
                                        <span class="float-right fw-n">&commat;{{ Auth::User()->nickname }}</span>
